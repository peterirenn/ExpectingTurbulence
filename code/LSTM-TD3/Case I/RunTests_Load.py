...
if __name__ == "__main__":
    ...
    machine = MachineL(**args.__dict__)
    machine._init(0)
    ...
    with nidaqmx.Task() as task:
        ...
        machine.state_mean[0,0] = machine.load_mean[0,0]
