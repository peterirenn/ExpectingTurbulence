...
class MachineP():
    ...
    def __init__(self, filter, *args, **kwargs):
        ...
        # Dimensionn of load
        self.load_dim = 1
        # Create agent_TD3 with the given state and action dimensions, and exploreation noise?
        self.agent = TD3(self.state_dim, self.action_dim)#, explore_noise = explore_noise)
    ...
    def _start_episode(self,state_mean, load_mean):
        ...
        """
        self.state_mean = state_mean #(1, state_dim)
