"""
Runs test on experimental aerodynamic testbed.

Runs TD3 algorithm through the Machine class.
"""
import os
import pickle
import tensorflow as tf
import numpy as np
from agent_TD3_basic_keras import TD3
from MachineLAP_basic import MachineLAP
...
if __name__ == "__main__":
    ...
    machine = MachineLAP(**args.__dict__)
    machine._init(0)
    ...
    n_steps = 100
    # Number of Episodes to run before longer evaluations
    n_episodes = 200
    ...
    with nidaqmx.Task() as task:
        ...
        machine.state_mean[0,n_sensors] = machine.load_mean[0,0]
        ...
        try:
            while True:
                ...
                while counter < T:
                    ...
                    try:
                        for i in range(n_sensors):
                            ...
                            #p_store[0,i] = ser.readline()
                        raw_data[0,n_sensors] = raw_load[0,0]
                        ...
                        is_err = True
                        ser.dtr = False
                    # Request an action - Iaction will be a number from -1 to 1
                    a = machine._request_stochastic_action(raw_data, raw_load)
                ...
                while counter < T:
                    ...
                    a = machine._request_deterministic_action(raw_data, raw_load)
