...
Updated to remove XML server aspects and for TF2.
...
class MachineLAP():
    ...
    #
    def _request_action(self, raw_data, raw_load, stochastic):
        """
        requests action
        ...
        # Get action
        action = self.agent.get_action(filtered_state, stochastic = stochastic)
    ...
    def _request_stochastic_action(self, raw_data, raw_load):
    """
    ...
    args:
        ...
        raw_load: raw (unfiltered) load data_
    """
        return self._request_action(raw_data, raw_load, True)

    def _request_deterministic_action(self, raw_data, raw_load):
    """
    ...
    args:
        ...
        raw_load: raw (unfiltered) load data_
    """
        return self._request_action(raw_data, raw_load, False)
